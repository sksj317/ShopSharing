        ...
        <div class="col-lg-9">
          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
              <div class="carousel-item1 active">
                <img class="d-block img-fluid" src="./resources/image/4444.jpg" alt="First slide" style='height:283px; width:825px' >
              </div>
          </div>
          ...
          <div class="row">
			...
			<c:forEach var="timeList" items="${timeList}" varStatus="status">
				<c:if test="${timeList.shopNum !=null }">
					<c:if test="${timeList.shopLentType =='메뉴테스트' }">
