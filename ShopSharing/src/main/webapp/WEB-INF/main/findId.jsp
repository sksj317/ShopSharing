...
<%@ include file="../include/mainTop.jsp" %>
	...
	<script type="text/javascript">
		function check(){
			...
			document.form.action = "${path}/ShopSharing/memberFindId.com"
		...
		<div class="col-md-12">
			...
			<form Name="form" method="post" class="form-horizontal">	
				...
				<c:if test="${msg == 'failure'}">
					<div style="color:red">
						이름  또는  전화번호가 일치하지 않습니다.
					</div>
				</c:if>	
				<div class="form-group">
					<div class="col-sm-12 text-center">
						<button class="btn btn-primary" type ="button" onclick="check()">아이디 찾기<i class="fa fa-check spaceLeft"></i></button>
