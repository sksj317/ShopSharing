...
<body>
	...
	<div class="container" style="height: 88%; width: 100%">
		...
		<form:form commandName="surveyCommand" action="shopSharingSurvey.com" method="POST" name="frm" onsubmit="return checkValue()">
		<div class="row">
			<div class="col-lg-3 mb-4">
			<h3 class="my-4">설문자 유형</h3>
				<div class="list-group">
					<a href="shopSharingSurvey.com" class="list-group-item active">점포제공자 대상 설문</a>
					<a href="shopLenderSurvey.com" class="list-group-item">점포대여자 대상 설문</a> 
					<a href="consignmentSurvey.com" class="list-group-item">상품제공자 대상 설문</a>
				...
				<div class="col-lg-6 mb-4">
					<div>
						<h3 class="my-4">점포제공자 대상 설문</h3>
						
					<p>대여점포명</p>
					<div class="shopName">
						<form:input type="text" id="shopName" path="shopName" placeholder="제공한 점포명을 입력해주세요." size="35px"/>
					</div>
					<br/>
					...
					<p>웹사이트 이용 만족도</p>
					    ...
					    <form:input type="hidden" value="" path="serviceStar" class="startNum" />
					    <span class="num"></span>
					    <br/>
					    ...
					    <form:input type="hidden" value="" path="mutualStar" class="startNum"/>
					    <span class="num"></span>
					    <br/>
					    ...
					    <form:input type="hidden" value="" path="facilitiesStar" class="startNum" />
					    <span class="num"></span>

					    <div>
					    	<br><p>재계약 희망여부</p>
					    	<label><form:radiobutton value="예" path="surveyRecharter"/>예</label>
					        <label><form:radiobutton value="아니요" path="surveyRecharter"/>아니요</label>
					    </div>
					...
					<form:input type="hidden" value="점포 대여자" path="memberType" class="startNum" /> <!-- 설문자 타입을 hidden으로 넘겨줌 --> 
...
<script type="text/javascript">
		...
		/* location.href='complaintInsert.com?complaint='+complaint;  우수 공유자를 제안할때 페이지 이동으로 활용*/
...
<script type="text/javascript">
		...
		$(function(){
			...
			var sBtn = $(".list-group > .list-group-item");   
	  		sBtn.find(".list-group-item").click(function(){ 
