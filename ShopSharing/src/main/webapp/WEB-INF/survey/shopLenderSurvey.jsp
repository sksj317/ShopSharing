...
<body>
	...
	<%-- <form action="customersurvey.com" name="cmtform" method="post"> --%>
		<form:form commandName="surveyCommand" name="frm" action="shopLenderSurvey.com" method="POST" onsubmit="return checkValue()">
		<div class="row">
			<div class="col-lg-3 mb-4">
				<h3 class="my-4">설문자 유형</h3>
				<div class="list-group">
					<a href="shopSharingSurvey.com" class="list-group-item">점포제공자 대상 설문</a>
					<a href="shopLenderSurvey.com" class="list-group-item active">점포대여자 대상 설문</a>
					<a href="consignmentSurvey.com" class="list-group-item">상품제공자 대상 설문</a>
					<a href="customerSurvey.com" class="list-group-item">고객대상 대상 설문</a>
				</div>
			</div>
			
				<div class="col-lg-6 mb-4">
					<div>
						<h3 class="my-4">점포대여자 대상 설문</h3>
						
						<p>대여점포명</p>
						<div class="shopName">
							<form:input type="text" id="shopName" path="shopName" placeholder="대여했던 점포명을 입력해주세요." size="35px"/>
						</div>
						<br/>
				    ...
				    <form:input type="hidden" value="점포 제공자" path="memberType" class="startNum" /> 
